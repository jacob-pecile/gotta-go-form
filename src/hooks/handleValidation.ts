import { FormField, FormType, FormDefinition, Section } from '../types/formtypes';
import { flatten } from 'lodash';

export const HandleFormValidation = (form: FormDefinition) => {
    form.sections = form.sections.map((section: Section) => HandleSectionValidation(section, form));

    return form;
};

export const HandleSectionValidation = (section: Section, form: FormDefinition): Section => {
